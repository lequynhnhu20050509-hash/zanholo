...
def create_image_from_code(code, command_name, font_path="modules/cache/font/SFMono-Bold.otf"):
    ...
    draw.text((mitai_text_x, mitai_text_y), mitai_text, font=header_font, fill=(0, 255, 255))
    ...
    draw.text((mitai_text_x, 10), mitai_text, font=header_font, fill=(0, 255, 255))
